...
| w    | 切换天气 |
| c    | 切换车辆颜色 |
| b    | 切换车辆品牌（Tesla/Ford Mustang/Chevrolet Spark等） |
| p    | 保存当前画面截图 |
...
### 2. 智能体生成模块
- **主车辆**：支持多种品牌车型（Tesla Model3/Ford Mustang/Chevrolet Spark等），关闭自动驾驶，由自定义控制算法控制
...
按 `b` 键后会在控制台显示菜单，切换时会保留当前车辆颜色设置。
